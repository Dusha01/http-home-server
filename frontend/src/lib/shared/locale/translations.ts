...
export const translations: Record<Locale, Record<string, string>> = {
	ru: {
		...
		'workspace.downloadFolder': 'Скачать папку {name}',
		'workspace.add': 'Добавить',
		'workspace.addFiles': 'Файлы',
		'workspace.addFolder': 'Папка',
		'workspace.addTextFile': 'Текстовый файл',
		'workspace.saveAs': 'Сохранить как',
		'workspace.newTextFile': 'Новый текстовый файл',
		'workspace.enterFilename': 'Укажите имя файла',
	...
	en: {
		...
		'workspace.downloadFolder': 'Download folder {name}',
		'workspace.add': 'Add',
		'workspace.addFiles': 'Files',
		'workspace.addFolder': 'Folder',
		'workspace.addTextFile': 'Text file',
		'workspace.saveAs': 'Save as',
		'workspace.newTextFile': 'New text file',
		'workspace.enterFilename': 'Enter filename',
